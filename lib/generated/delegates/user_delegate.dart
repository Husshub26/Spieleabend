...
class UserDelegate {
  ...
  /// Find multiple Users as raw maps (use with include/computed)
  ...
  /// Find the first User as a raw map (use with include/computed)
  ...
  Future<int> createMany({required List<CreateUserInput> data}) async {
    final query = JsonQueryBuilder()
        .model('User')
